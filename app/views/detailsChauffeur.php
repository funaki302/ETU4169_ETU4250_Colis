...
<?php 
    ...
    $profileImage = !empty($chauffeur['profile']) ? '/images/' . htmlspecialchars($chauffeur['profile']) : null;
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="ms-4">
                        ...
                        <span class="badge bg-primary rounded-pill px-3 py-2"><?= htmlspecialchars($chauffeur['statut'] ?? 'disponible') ?></span>
                        <?php if (!empty($chauffeur['email_chauffeur'])): ?>
                            <p class="text-muted mb-0 mt-2">
                                <i class="bi bi-envelope me-2"></i><?= htmlspecialchars($chauffeur['email_chauffeur']) ?>
                            </p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <form method="post" action="/chauffeur/update" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="prenom_chauffeur" class="form-control" 
                        ...
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-calendar-event me-2"></i>Date d'assignation</label>
                            <input type="date" name="date_dassignation" class="form-control" 
                                   value="<?= htmlspecialchars($chauffeur['date_dassignation'] ?? '') ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-currency-euro me-2"></i>Salaire par livraison</label>
                        ...
                        <div class="col-12">
                            ...
                            <?php if ($profileImage): ?>
                                <small class="text-muted d-block mt-2">
                                    ...
                                    Photo actuelle : <?= htmlspecialchars($chauffeur['profile']) ?>
                                </small>
                            <?php else: ?>
